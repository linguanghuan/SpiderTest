...
public class OrlionCnblogsPageProcessor implements PageProcessor {
...
//    private static final String BLOG_ID = "129585"; 
	...
	public void process(Page page) {
		if (page.getUrl().regex(LIST_URL).match())
		{
			...
			Selectable targets = html.xpath("//div[@id='topicList']/div[@class='day']");
...
//		Spider.create(new CnblogsLittleHannPageProcessor()).addUrl("http://www.cnblogs.com/LittleHann/default.html?page=1").thread(1).run();
		OrlionCnblogsPageProcessor cnblogsLittleHannPageProcessor = new OrlionCnblogsPageProcessor();
